...
configurations = {
    1: dict(
        ...
        MODEL_ROOT = '../model/model37', # the root to buffer your checkpoints
        LOG_ROOT = 'log/log37', # the root to log your train/val status
        ...
        MOMENTUM = 0.9,
        STAGES = [18, 38, 48], # epoch stages to decay learning rate
