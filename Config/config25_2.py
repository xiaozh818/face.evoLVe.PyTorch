...
configurations = {
    1: dict(
        ...
        MODEL_ROOT = './model/model25_2', # the root to buffer your checkpoints
        LOG_ROOT = 'log/log25_2', # the root to log your train/val status
        ...
        INPUT_SIZE = [128, 128], # support: [112, 112] and [224, 224]
