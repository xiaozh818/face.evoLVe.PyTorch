...
configurations = {
    1: dict(
        ...
        MODEL_ROOT = '/home/wenhaoran/model/model5', # the root to buffer your checkpoints
        LOG_ROOT = 'log/log5', # the root to log your train/val status
        ...
        RGB_STD = [0.5, 0.5, 0.5],
        EMBEDDING_SIZE = 1024, # feature dimension 512 for ResNet, IR, IR_SE and 1024 for shufflenet and 256 for mobileface
        BATCH_SIZE = 512,
