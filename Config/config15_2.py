...
configurations = {
    1: dict(
        ...
        MODEL_ROOT = './model/model15_2', # the root to buffer your checkpoints
        LOG_ROOT = 'log/log15_2', # the root to log your train/val status
        ...
        PIN_MEMORY = True,
        NUM_WORKERS = 8,
		POOLING = 'AvgPool', # ['Linear', 'GDConv', 'AvgPool'], default is 'Linear'
),
}
