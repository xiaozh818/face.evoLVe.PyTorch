...
configurations = {
    1: dict(
        ...
        MODEL_ROOT = '/home/wenhaoran/model/model10', # the root to buffer your checkpoints
        LOG_ROOT = 'log/log10', # the root to log your train/val status
        BACKBONE_RESUME_ROOT = '/home/wenhaoran/model/model8/Backbone_ShuffleNetV2_Epoch_3_Batch_34116_Time_2019-04-06-21-11_checkpoint.pth', # the root to resume training from a saved checkpoint
        HEAD_RESUME_ROOT = '/home/wenhaoran/model/model8/Head_CosFace_Epoch_3_Batch_34116_Time_2019-04-06-21-11_checkpoint.pth', # the root to resume training from a saved checkpoint
