...
configurations = {
    1: dict(
        ...
        MODEL_ROOT = './model/model15_1', # the root to buffer your checkpoints
        LOG_ROOT = 'log/log15_1', # the root to log your train/val status
        ...
        GPU_ID = [5, 6, 7], # specify your GPU ids
        PIN_MEMORY = True,
        NUM_WORKERS = 8,
),
}
