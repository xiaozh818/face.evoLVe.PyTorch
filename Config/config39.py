...
configurations = {
    1: dict(
        ...
        DATA_ROOT = '/data/xiaozihao/faces_emore', # the parent root where your train/val/test data are stored
        MODEL_ROOT = './model/model39', # the root to buffer your checkpoints
        LOG_ROOT = 'log/log39', # the root to log your train/val status
