...
configurations = {
    1: dict(
        ...
        MODEL_ROOT = './model/model25', # the root to buffer your checkpoints
        LOG_ROOT = 'log/log25', # the root to log your train/val status
        BACKBONE_RESUME_ROOT = './model/model25/Backbone_ShuffleNet_Epoch_4_Batch_45488_Time_2019-04-20-08-58_checkpoint.pth', # the root to resume training from a saved checkpoint
        HEAD_RESUME_ROOT = './model/model25/Head_CosFace_Epoch_4_Batch_45488_Time_2019-04-20-08-58_checkpoint.pth', # the root to resume training from a saved checkpoint
