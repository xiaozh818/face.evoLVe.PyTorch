...
configurations = {
    1: dict(
        ...
        MODEL_ROOT = './model/model9.2', # the root to buffer your checkpoints
        LOG_ROOT = 'log/log9.2', # the root to log your train/val status
        ...
        GPU_ID = [1, 2, 3, 4, 5, 6, 7], # specify your GPU ids
        PIN_MEMORY = True,
        NUM_WORKERS = 8,
),
}
